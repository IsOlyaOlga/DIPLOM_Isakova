...
// {{ Исакова О.С. печать документа Реализация товаров и услуг.
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт 
	...
	Если ПечатнаяФорма <> Неопределено Тогда
	    ...
	    ПечатнаяФорма.ПолныйПутьКМакету = "Документ.РеализацияТоваровУслуг.ПФ_MXL_АктОбОказанныхУслугах_ВКМ";
	КонецЕсли;
...
Функция ПечатьАкта(МассивОбъектов, ОбъектыПечати)
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.РеализацияТоваровУслуг.ПФ_MXL_АктОбОказанныхУслугах_ВКМ");
...
Функция ПолучитьДанныеДокументов(МассивОбъектов)
	...
	|	РеализацияТоваровУслуг.Договор.ВКМ_ДатаНачалаДействияДоговора КАК ДатаНачалаДействияДоговора,
...
Процедура ВывестиЗаголовокАкта(ДанныеДокументов, ТабличныйДокумент, Макет)
	...
	ДанныеПечати.Вставить("ПредставлениеДаты", Формат(ДанныеДокументов.ДатаНачалаДействияДоговора, "ДФ=dd.MM.yyyy"));
...
Процедура ВывестиСуммуПрописью(ДанныеДокументов, ТабличныйДокумент, Макет)
	...
	ШаблонСуммы = "Всего по акту: %1 рублей, 00 копеек.";
	ТекстСуммы = СтрШаблон(ШаблонСуммы,
		ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(ЧислоПрописью(ДанныеДокументов.СуммаДокумента)),);
